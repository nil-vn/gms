...
function layout_theme_sidebar_change(value) {
  ...
  if (logo) {
    const logoSrc = value === 'true' ? getBasePath() + 'common/img/logo-dark.svg' : getBasePath() + 'common/img/logo-white.svg';
...
function resetAllThemeSettings() {
  ...
  // Reset logos
  updateLogo('.footer-top .footer-logo', getBasePath() + 'common/img/logo-dark.svg');
  updateLogo('.brand-logo', getBasePath() + 'common/img/logo-dark.svg');
  updateLogo('.invoice-logo', getBasePath() + 'common/img/logo-dark.svg');
  updateLogo('.auth-wrapper:not(.v3) a>img', getBasePath() + 'common/img/logo.jpg');
  updateLogo('[data-pc-layout="horizontal"] .pc-sidebar .m-header .logo-lg', getBasePath() + 'common/img/logo-dark.svg');
  updateLogo('.pc-sidebar .m-header .logo-lg', getBasePath() + 'common/img/logo-white.svg');
